...
int main()
{
    ...
    while (1)
    {
        if (current > last) { break; } // If all nodes are processed, exit the loop

        if (list[current]->value == -99) { current++; continue; } // Skip processing if current node is a placeholder
